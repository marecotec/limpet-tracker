...
#First we need to read in the data, let's set a location for Alex
setwd("/Users/Alex/Dropbox/Gardner/Data")

#location for Andy
setwd("C:/Users/ossa06/Desktop/Dropbox/Students/Gardner/Data")
